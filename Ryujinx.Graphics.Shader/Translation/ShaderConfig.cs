...
namespace Ryujinx.Graphics.Shader.Translation
{
    class ShaderConfig
    {
        ...
        public bool HasTransformFeedbackOutputs()
        {
            return TransformFeedbackEnabled && LastInVertexPipeline;
        }
        ...
        {
            if (ioVariable != IoVariable.UserDefined || !isOutput || !HasTransformFeedbackOutputs())
            {
                return false;
            }
